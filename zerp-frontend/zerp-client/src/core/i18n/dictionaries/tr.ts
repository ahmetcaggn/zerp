export const trMessages = {
  ...
  landing: {
    ...
    feature1Desc: 'QR kodlu, çoklu dil destekli ve gerçek zamanlı güncellenebilen akıllı menü sistemi.',
    ...
    feature3Desc: 'Anlık stok durumu, otomatik uyarılar ve maliyet analizi ile kayıpları minimize edin.',
    feature4Title: 'Analitik & Raporlar',
    feature4Desc:
      'Satış trendlerini izleyin, en çok satan ürünleri keşfedin ve veri odaklı kararlar alın.',
    statsTitle: 'Rakamlarla ZERP',
    stat1Value: '500+',
    stat1Label: 'Aktif İşletme',
    stat2Value: '1M+',
    stat2Label: 'Aylık Sipariş',
    stat3Value: '%30',
    stat3Label: 'Verimlilik Artışı',
    stat4Value: '7/24',
    stat4Label: 'Destek',
