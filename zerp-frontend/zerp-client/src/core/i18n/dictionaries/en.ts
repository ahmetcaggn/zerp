export const enMessages = {
  ...
  restaurants: {
    ...
    cuisineSectionTitle: 'Cuisines',
    cityLabel: 'City',
    districtLabel: 'District / Neighborhood',
    cuisineCategoryLabel: 'Cuisine',
    cuisineSearchPlaceholder: 'Search cuisines',
    showMoreCuisines: 'Show more',
    filterAll: 'All',
    sortLabel: 'Sort',
    ...
    allWorkingHours: 'All Hours',
    openAllDay: 'Open 24 hours',
    workingHoursUnavailable: 'Working hours have not been provided yet.',
