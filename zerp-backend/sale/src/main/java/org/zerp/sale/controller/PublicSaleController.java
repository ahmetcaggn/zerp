...
public class PublicSaleController {
    ...
    public ResponseEntity<ApiResponse<PublicShopFeedResponseDTO>> getShopsFeed(
            ...
            @RequestParam(name = "cuisineCategory", required = false) String cuisineCategory,
            @RequestParam(name = "cuisineCategories", required = false) List<String> cuisineCategories,
