...
public class MenuItemFilterSpecGenerator implements IFilterSpecGenerator<MenuItem> {
    private final FilterProcessor filterProcessor;

    @Override
    public Specification<MenuItem> generateSpecification(List<String> parts, FilterOperator operator, String value) {
        log.debug("Generating MenuItem specification: parts={}, operator={}, value={}", parts, operator, value);
    ...
    @Override
    public Specification<MenuItem> generateGlobalSearchSpecification(String value) {
