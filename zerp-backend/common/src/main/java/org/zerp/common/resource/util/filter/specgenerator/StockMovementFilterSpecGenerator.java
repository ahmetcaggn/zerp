...
public class StockMovementFilterSpecGenerator implements IFilterSpecGenerator<StockMovement> {
    private final FilterProcessor filterProcessor;

    @Override
    public Specification<StockMovement> generateSpecification(List<String> parts, FilterOperator operator, String value) {
        log.debug("Generating StockMovement specification: parts={}, operator={}, value={}", parts, operator, value);
    ...
    @Override
    public Specification<StockMovement> generateGlobalSearchSpecification(String value) {
