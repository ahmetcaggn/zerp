...
public class MenuFilterSpecGenerator implements IFilterSpecGenerator<Menu> {
    private final FilterProcessor filterProcessor;

    @Override
    public Specification<Menu> generateSpecification(List<String> parts, FilterOperator operator, String value) {
        log.debug("Generating Menu specification: parts={}, operator={}, value={}", parts, operator, value);
    ...
    @Override
    public Specification<Menu> generateGlobalSearchSpecification(String value) {
