...
public class History {
    ...
    private History(EventType eventType, Integer actorId, String referenceType, Integer referenceId, String payload,
    ...
    public static History createWithReference(EventType eventType, Integer actorId, String referenceType,
            Integer referenceId, String payload) {
