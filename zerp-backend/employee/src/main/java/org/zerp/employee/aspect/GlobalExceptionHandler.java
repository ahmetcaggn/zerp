...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<ProblemDetail> handleEntityNotFoundException(EntityNotFoundException exception) {
        ...
        return ResponseEntity.status(HttpStatus.NOT_FOUND).body(
                problemDetailFactory.buildProblem(HttpStatus.NOT_FOUND, "NOT_FOUND", exception.getMessage()));
    }

    @ExceptionHandler(DuplicateResourceException.class)
    public ResponseEntity<ProblemDetail> handleDuplicateResourceException(DuplicateResourceException exception) {
        log.error(exception.getMessage(), exception);
        return ResponseEntity.status(HttpStatus.CONFLICT).body(problemDetailFactory.buildProblem(
                HttpStatus.CONFLICT,
                "DUPLICATE_RESOURCE",
