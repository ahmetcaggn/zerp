# openapi_notification.api.ObjectsPatchManyApi
...
------------- | ------------- | -------------
[**patchMany**](ObjectsPatchManyApi.md#) | **PATCH** /notification/announcements | UpdateMany: Update multiple entities


# **patchMany**
> ApiResponseListUUID patchMany(requestBody, id)
...
final api_instance = ObjectsPatchManyApi();
...
try {
    ...
    print('Exception when calling ObjectsPatchManyApi->patchMany: $e\n');
}
```
