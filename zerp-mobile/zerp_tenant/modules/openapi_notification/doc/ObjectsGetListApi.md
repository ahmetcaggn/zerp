# openapi_notification.api.ObjectsGetListApi
...
------------- | ------------- | -------------
[**getList**](ObjectsGetListApi.md#) | **GET** /notification/announcements | GetList: Get paginated list of entities with filtering


# **getList**
> ApiResponseListAnnouncementResponseDto getList(start, end, allParams, sort, order, embed)
...
final api_instance = ObjectsGetListApi();
...
try {
    final result = api_instance.getList(start, end, allParams, sort, order, embed);
    print(result);
} catch (e) {
    print('Exception when calling ObjectsGetListApi->getList: $e\n');
}
```
...
[**ApiResponseListAnnouncementResponseDto**](ApiResponseListAnnouncementResponseDto.md)
