# openapi_notification.api.ObjectsGetManyApi
...
------------- | ------------- | -------------
[**getMany**](ObjectsGetManyApi.md#) | **GET** /notification/announcements/many | GetMany: Get multiple entities by IDs


# **getMany**
> ApiResponseListAnnouncementResponseDto getMany(id)
...
final api_instance = ObjectsGetManyApi();
final id = [[1,5,12]]; // List<String> | List of entity IDs to retrieve

try {
    final result = api_instance.getMany(id);
    print(result);
} catch (e) {
    print('Exception when calling ObjectsGetManyApi->getMany: $e\n');
}
```
