...
/// tests for ObjectsGetListApi
void main() {
  // final instance = ObjectsGetListApi();

  group('tests for ObjectsGetListApi', () {
    ...
    //
    //Future<ApiResponseListAnnouncementResponseDto> getList(int start, int end, Map<String, String> allParams, { String sort, String order, String embed }) async
