...
/// tests for ObjectsGetManyApi
void main() {
  // final instance = ObjectsGetManyApi();

  group('tests for ObjectsGetManyApi', () {
    ...
    //
    //Future<ApiResponseListAnnouncementResponseDto> getMany(List<String> id) async
    test('test getMany', () async {
      // TODO
    });
