...
/// tests for ObjectsCreateApi
void main() {
  // final instance = ObjectsCreateApi();

  group('tests for ObjectsCreateApi', () {
    ...
    //
    //Future<ApiResponseAnnouncementResponseDto> create(CreateAnnouncementRequestDto createAnnouncementRequestDto) async
