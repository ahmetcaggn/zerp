...
/// tests for ObjectsGetOneApi
void main() {
  // final instance = ObjectsGetOneApi();

  group('tests for ObjectsGetOneApi', () {
    ...
    //
    //Future<ApiResponseAnnouncementResponseDto> getOne(String id) async
