...
/// tests for ObjectsCallPatchApi
void main() {
  // final instance = ObjectsCallPatchApi();

  group('tests for ObjectsCallPatchApi', () {
    ...
    //
    //Future<ApiResponseAnnouncementResponseDto> callPatch(String id, Map<String, Object> requestBody) async
    test('test callPatch', () async {
      // TODO
    });
