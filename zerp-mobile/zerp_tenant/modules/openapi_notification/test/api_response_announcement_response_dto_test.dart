...
// tests for ApiResponseAnnouncementResponseDto
void main() {
  // final instance = ApiResponseAnnouncementResponseDto();

  group('test ApiResponseAnnouncementResponseDto', () {
    // bool success
