...
// tests for ApiResponseListAnnouncementResponseDto
void main() {
  // final instance = ApiResponseListAnnouncementResponseDto();

  group('test ApiResponseListAnnouncementResponseDto', () {
    // bool success
    ...
    // List<AnnouncementResponseDto> data (default value: const [])
