# openapi_sale.api.MenuItemGetListMenuItemApi
...
------------- | ------------- | -------------
[**getListMenuItem**](MenuItemGetListMenuItemApi.md#) | **GET** /sale/menu-items | GetList: Get paginated list of entities with filtering


# **getListMenuItem**
> ApiResponseListMenuItemDTO getListMenuItem(start, end, allParams, sort, order, embed)
...
final api_instance = MenuItemGetListMenuItemApi();
...
try {
    final result = api_instance.getListMenuItem(start, end, allParams, sort, order, embed);
    print(result);
} catch (e) {
    print('Exception when calling MenuItemGetListMenuItemApi->getListMenuItem: $e\n');
}
```
...
[**ApiResponseListMenuItemDTO**](ApiResponseListMenuItemDTO.md)
