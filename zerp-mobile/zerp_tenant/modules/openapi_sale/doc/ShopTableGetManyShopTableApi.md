# openapi_sale.api.ShopTableGetManyShopTableApi
...
------------- | ------------- | -------------
[**getManyShopTable**](ShopTableGetManyShopTableApi.md#) | **GET** /sale/tables/many | GetMany: Get multiple entities by IDs


# **getManyShopTable**
> ApiResponseListShopTableDTO getManyShopTable(id)
...
final api_instance = ShopTableGetManyShopTableApi();
final id = [[1,5,12]]; // List<String> | List of entity IDs to retrieve

try {
    final result = api_instance.getManyShopTable(id);
    print(result);
} catch (e) {
    print('Exception when calling ShopTableGetManyShopTableApi->getManyShopTable: $e\n');
}
```
