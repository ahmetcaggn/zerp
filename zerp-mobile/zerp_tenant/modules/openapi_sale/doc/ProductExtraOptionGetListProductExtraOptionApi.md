# openapi_sale.api.ProductExtraOptionGetListProductExtraOptionApi
...
------------- | ------------- | -------------
[**getListProductExtraOption**](ProductExtraOptionGetListProductExtraOptionApi.md#) | **GET** /sale/product-extra-options | GetList: Get paginated list of entities with filtering


# **getListProductExtraOption**
> ApiResponseListProductExtraOptionDTO getListProductExtraOption(start, end, allParams, sort, order, embed)
...
final api_instance = ProductExtraOptionGetListProductExtraOptionApi();
...
try {
    final result = api_instance.getListProductExtraOption(start, end, allParams, sort, order, embed);
    print(result);
} catch (e) {
    print('Exception when calling ProductExtraOptionGetListProductExtraOptionApi->getListProductExtraOption: $e\n');
}
```
...
[**ApiResponseListProductExtraOptionDTO**](ApiResponseListProductExtraOptionDTO.md)
