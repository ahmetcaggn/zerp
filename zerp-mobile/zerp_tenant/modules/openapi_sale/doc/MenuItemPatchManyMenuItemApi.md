# openapi_sale.api.MenuItemPatchManyMenuItemApi
...
------------- | ------------- | -------------
[**patchManyMenuItem**](MenuItemPatchManyMenuItemApi.md#) | **PATCH** /sale/menu-items | UpdateMany: Update multiple entities


# **patchManyMenuItem**
> ApiResponseListUUID patchManyMenuItem(requestBody, id)
...
final api_instance = MenuItemPatchManyMenuItemApi();
final requestBody = Map<String, Object>(); // Map<String, Object> | 
final id = [[1, 2, 3]]; // List<String> | List of entity IDs to update

try {
    final result = api_instance.patchManyMenuItem(requestBody, id);
    print(result);
} catch (e) {
    print('Exception when calling MenuItemPatchManyMenuItemApi->patchManyMenuItem: $e\n');
}
```
