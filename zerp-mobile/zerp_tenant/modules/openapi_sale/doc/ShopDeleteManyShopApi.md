# openapi_sale.api.ShopDeleteManyShopApi
...
------------- | ------------- | -------------
[**deleteManyShop**](ShopDeleteManyShopApi.md#) | **DELETE** /sale/shops | DeleteMany: Delete multiple entities


# **deleteManyShop**
> ApiResponseListUUID deleteManyShop(id)
...
final api_instance = ShopDeleteManyShopApi();
final id = [[1, 2, 3]]; // List<String> | List of entity IDs to delete

try {
    final result = api_instance.deleteManyShop(id);
    print(result);
} catch (e) {
    print('Exception when calling ShopDeleteManyShopApi->deleteManyShop: $e\n');
}
```
