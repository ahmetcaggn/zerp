# openapi_sale.api.MenuGetListMenuApi
...
------------- | ------------- | -------------
[**getListMenu**](MenuGetListMenuApi.md#) | **GET** /sale/menus | GetList: Get paginated list of entities with filtering


# **getListMenu**
> ApiResponseListMenuDTO getListMenu(start, end, allParams, sort, order, embed)
...
final api_instance = MenuGetListMenuApi();
...
try {
    final result = api_instance.getListMenu(start, end, allParams, sort, order, embed);
    print(result);
} catch (e) {
    print('Exception when calling MenuGetListMenuApi->getListMenu: $e\n');
}
```
...
[**ApiResponseListMenuDTO**](ApiResponseListMenuDTO.md)
