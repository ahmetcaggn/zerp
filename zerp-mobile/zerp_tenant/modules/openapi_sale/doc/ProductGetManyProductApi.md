# openapi_sale.api.ProductGetManyProductApi
...
------------- | ------------- | -------------
[**getManyProduct**](ProductGetManyProductApi.md#) | **GET** /sale/products/many | GetMany: Get multiple entities by IDs


# **getManyProduct**
> ApiResponseListProductDTO getManyProduct(id)
...
final api_instance = ProductGetManyProductApi();
final id = [[1, 5, 12]]; // List<String> | List of entity IDs to retrieve

try {
    final result = api_instance.getManyProduct(id);
    print(result);
} catch (e) {
    print('Exception when calling ProductGetManyProductApi->getManyProduct: $e\n');
}
```
