# openapi_sale.api.ShopGetManyShopApi
...
------------- | ------------- | -------------
[**getManyShop**](ShopGetManyShopApi.md#) | **GET** /sale/shops/many | GetMany: Get multiple entities by IDs


# **getManyShop**
> ApiResponseListShopDTO getManyShop(id)
...
final api_instance = ShopGetManyShopApi();
final id = [[1, 5, 12]]; // List<String> | List of entity IDs to retrieve

try {
    final result = api_instance.getManyShop(id);
    print(result);
} catch (e) {
    print('Exception when calling ShopGetManyShopApi->getManyShop: $e\n');
}
```
