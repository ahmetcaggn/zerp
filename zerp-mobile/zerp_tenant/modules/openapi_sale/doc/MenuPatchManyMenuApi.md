# openapi_sale.api.MenuPatchManyMenuApi
...
------------- | ------------- | -------------
[**patchManyMenu**](MenuPatchManyMenuApi.md#) | **PATCH** /sale/menus | UpdateMany: Update multiple entities


# **patchManyMenu**
> ApiResponseListUUID patchManyMenu(requestBody, id)
...
final api_instance = MenuPatchManyMenuApi();
final requestBody = Map<String, Object>(); // Map<String, Object> | 
final id = [[1, 2, 3]]; // List<String> | List of entity IDs to update

try {
    final result = api_instance.patchManyMenu(requestBody, id);
    print(result);
} catch (e) {
    print('Exception when calling MenuPatchManyMenuApi->patchManyMenu: $e\n');
}
```
