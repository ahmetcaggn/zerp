# openapi_sale.api.ShopTablePatchManyShopTableApi
...
------------- | ------------- | -------------
[**patchManyShopTable**](ShopTablePatchManyShopTableApi.md#) | **PATCH** /sale/tables | UpdateMany: Update multiple entities


# **patchManyShopTable**
> ApiResponseListUUID patchManyShopTable(requestBody, id)
...
final api_instance = ShopTablePatchManyShopTableApi();
final requestBody = Map<String, Object>(); // Map<String, Object> | 
final id = [[1,2,3]]; // List<String> | List of entity IDs to update

try {
    final result = api_instance.patchManyShopTable(requestBody, id);
    print(result);
} catch (e) {
    print('Exception when calling ShopTablePatchManyShopTableApi->patchManyShopTable: $e\n');
}
```
