# openapi_sale.api.ProductExtraOptionGetManyProductExtraOptionApi
...
------------- | ------------- | -------------
[**getManyProductExtraOption**](ProductExtraOptionGetManyProductExtraOptionApi.md#) | **GET** /sale/product-extra-options/many | GetMany: Get multiple entities by IDs


# **getManyProductExtraOption**
> ApiResponseListProductExtraOptionDTO getManyProductExtraOption(id)
...
final api_instance = ProductExtraOptionGetManyProductExtraOptionApi();
final id = [[1, 5, 12]]; // List<String> | List of entity IDs to retrieve

try {
    final result = api_instance.getManyProductExtraOption(id);
    print(result);
} catch (e) {
    print('Exception when calling ProductExtraOptionGetManyProductExtraOptionApi->getManyProductExtraOption: $e\n');
}
```
