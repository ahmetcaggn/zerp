# openapi_sale.api.ProductRecipeGetManyProductRecipeApi
...
------------- | ------------- | -------------
[**getManyProductRecipe**](ProductRecipeGetManyProductRecipeApi.md#) | **GET** /sale/product-recipes/many | GetMany: Get multiple entities by IDs


# **getManyProductRecipe**
> ApiResponseListProductRecipeDTO getManyProductRecipe(id)
...
final api_instance = ProductRecipeGetManyProductRecipeApi();
final id = [[1, 5, 12]]; // List<String> | List of entity IDs to retrieve

try {
    final result = api_instance.getManyProductRecipe(id);
    print(result);
} catch (e) {
    print('Exception when calling ProductRecipeGetManyProductRecipeApi->getManyProductRecipe: $e\n');
}
```
