# openapi_sale.api.ProductRecipeGetListProductRecipeApi
...
------------- | ------------- | -------------
[**getListProductRecipe**](ProductRecipeGetListProductRecipeApi.md#) | **GET** /sale/product-recipes | GetList: Get paginated list of entities with filtering


# **getListProductRecipe**
> ApiResponseListProductRecipeDTO getListProductRecipe(start, end, allParams, sort, order, embed)
...
final api_instance = ProductRecipeGetListProductRecipeApi();
...
try {
    final result = api_instance.getListProductRecipe(start, end, allParams, sort, order, embed);
    print(result);
} catch (e) {
    print('Exception when calling ProductRecipeGetListProductRecipeApi->getListProductRecipe: $e\n');
}
```
...
[**ApiResponseListProductRecipeDTO**](ApiResponseListProductRecipeDTO.md)
