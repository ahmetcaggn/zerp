# openapi_sale.api.ShopGetListShopApi
...
------------- | ------------- | -------------
[**getListShop**](ShopGetListShopApi.md#) | **GET** /sale/shops | GetList: Get paginated list of entities with filtering


# **getListShop**
> ApiResponseListShopDTO getListShop(start, end, allParams, sort, order, embed)
...
final api_instance = ShopGetListShopApi();
...
try {
    final result = api_instance.getListShop(start, end, allParams, sort, order, embed);
    print(result);
} catch (e) {
    print('Exception when calling ShopGetListShopApi->getListShop: $e\n');
}
```
...
[**ApiResponseListShopDTO**](ApiResponseListShopDTO.md)
