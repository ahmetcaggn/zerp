# openapi_sale.api.MenuItemDeleteManyMenuItemApi
...
------------- | ------------- | -------------
[**deleteManyMenuItem**](MenuItemDeleteManyMenuItemApi.md#) | **DELETE** /sale/menu-items | DeleteMany: Delete multiple entities


# **deleteManyMenuItem**
> ApiResponseListUUID deleteManyMenuItem(id)
...
final api_instance = MenuItemDeleteManyMenuItemApi();
final id = [[1, 2, 3]]; // List<String> | List of entity IDs to delete

try {
    final result = api_instance.deleteManyMenuItem(id);
    print(result);
} catch (e) {
    print('Exception when calling MenuItemDeleteManyMenuItemApi->deleteManyMenuItem: $e\n');
}
```
