# openapi_sale.api.TableOrderGetListTableOrderApi
...
------------- | ------------- | -------------
[**getListTableOrder**](TableOrderGetListTableOrderApi.md#) | **GET** /sale/table-orders | GetList: Get paginated list of entities with filtering


# **getListTableOrder**
> ApiResponseListTableOrderDTO getListTableOrder(start, end, allParams, sort, order, embed)
...
final api_instance = TableOrderGetListTableOrderApi();
...
try {
    final result = api_instance.getListTableOrder(start, end, allParams, sort, order, embed);
    print(result);
} catch (e) {
    print('Exception when calling TableOrderGetListTableOrderApi->getListTableOrder: $e\n');
}
```
...
[**ApiResponseListTableOrderDTO**](ApiResponseListTableOrderDTO.md)
