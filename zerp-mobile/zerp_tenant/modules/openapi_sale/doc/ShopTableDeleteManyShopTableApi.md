# openapi_sale.api.ShopTableDeleteManyShopTableApi
...
------------- | ------------- | -------------
[**deleteManyShopTable**](ShopTableDeleteManyShopTableApi.md#) | **DELETE** /sale/tables | DeleteMany: Delete multiple entities


# **deleteManyShopTable**
> ApiResponseListUUID deleteManyShopTable(id)
...
final api_instance = ShopTableDeleteManyShopTableApi();
final id = [[1,2,3]]; // List<String> | List of entity IDs to delete

try {
    final result = api_instance.deleteManyShopTable(id);
    print(result);
} catch (e) {
    print('Exception when calling ShopTableDeleteManyShopTableApi->deleteManyShopTable: $e\n');
}
```
