# openapi_sale.api.MenuCategoryGetManyMenuCategoryApi
...
------------- | ------------- | -------------
[**getManyMenuCategory**](MenuCategoryGetManyMenuCategoryApi.md#) | **GET** /sale/menu-categories/many | GetMany: Get multiple entities by IDs


# **getManyMenuCategory**
> ApiResponseListMenuCategoryDTO getManyMenuCategory(id)
...
final api_instance = MenuCategoryGetManyMenuCategoryApi();
final id = [[1, 5, 12]]; // List<String> | List of entity IDs to retrieve

try {
    final result = api_instance.getManyMenuCategory(id);
    print(result);
} catch (e) {
    print('Exception when calling MenuCategoryGetManyMenuCategoryApi->getManyMenuCategory: $e\n');
}
```
