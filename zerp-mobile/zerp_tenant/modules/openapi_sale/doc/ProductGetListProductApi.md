# openapi_sale.api.ProductGetListProductApi
...
------------- | ------------- | -------------
[**getListProduct**](ProductGetListProductApi.md#) | **GET** /sale/products | GetList: Get paginated list of entities with filtering


# **getListProduct**
> ApiResponseListProductDTO getListProduct(start, end, allParams, sort, order, embed)
...
final api_instance = ProductGetListProductApi();
...
try {
    final result = api_instance.getListProduct(start, end, allParams, sort, order, embed);
    print(result);
} catch (e) {
    print('Exception when calling ProductGetListProductApi->getListProduct: $e\n');
}
```
...
[**ApiResponseListProductDTO**](ApiResponseListProductDTO.md)
