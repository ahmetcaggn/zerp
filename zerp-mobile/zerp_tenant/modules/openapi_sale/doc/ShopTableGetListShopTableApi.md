# openapi_sale.api.ShopTableGetListShopTableApi
...
------------- | ------------- | -------------
[**getListShopTable**](ShopTableGetListShopTableApi.md#) | **GET** /sale/tables | GetList: Get paginated list of entities with filtering


# **getListShopTable**
> ApiResponseListShopTableDTO getListShopTable(start, end, allParams, sort, order, embed)
...
final api_instance = ShopTableGetListShopTableApi();
...
try {
    final result = api_instance.getListShopTable(start, end, allParams, sort, order, embed);
    print(result);
} catch (e) {
    print('Exception when calling ShopTableGetListShopTableApi->getListShopTable: $e\n');
}
```
...
[**ApiResponseListShopTableDTO**](ApiResponseListShopTableDTO.md)
