# openapi_sale.api.MenuGetManyMenuApi
...
------------- | ------------- | -------------
[**getManyMenu**](MenuGetManyMenuApi.md#) | **GET** /sale/menus/many | GetMany: Get multiple entities by IDs


# **getManyMenu**
> ApiResponseListMenuDTO getManyMenu(id)
...
final api_instance = MenuGetManyMenuApi();
final id = [[1, 5, 12]]; // List<String> | List of entity IDs to retrieve

try {
    final result = api_instance.getManyMenu(id);
    print(result);
} catch (e) {
    print('Exception when calling MenuGetManyMenuApi->getManyMenu: $e\n');
}
```
