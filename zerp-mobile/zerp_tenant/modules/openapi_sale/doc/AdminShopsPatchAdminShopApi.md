# openapi_sale.api.AdminShopsPatchAdminShopApi
...
------------- | ------------- | -------------
[**patchAdminShop**](AdminShopsPatchAdminShopApi.md#) | **PATCH** /sale/admin/shops/{id} | Update: Update an existing entity


# **patchAdminShop**
> ApiResponseAdminShopResponseDTO patchAdminShop(id, requestBody)
...
final api_instance = AdminShopsPatchAdminShopApi();
final id = 1; // String | Unique identifier of the entity to update
final requestBody = Map<String, Object>(); // Map<String, Object> | 

try {
    final result = api_instance.patchAdminShop(id, requestBody);
    print(result);
} catch (e) {
    print('Exception when calling AdminShopsPatchAdminShopApi->patchAdminShop: $e\n');
}
```
