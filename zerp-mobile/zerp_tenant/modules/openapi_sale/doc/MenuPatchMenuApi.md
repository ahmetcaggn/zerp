# openapi_sale.api.MenuPatchMenuApi
...
------------- | ------------- | -------------
[**patchMenu**](MenuPatchMenuApi.md#) | **PATCH** /sale/menus/{id} | Update: Update an existing entity


# **patchMenu**
> ApiResponseMenuDTO patchMenu(id, requestBody)
...
final api_instance = MenuPatchMenuApi();
final id = 1; // String | Unique identifier of the entity to update
final requestBody = Map<String, Object>(); // Map<String, Object> | 

try {
    final result = api_instance.patchMenu(id, requestBody);
    print(result);
} catch (e) {
    print('Exception when calling MenuPatchMenuApi->patchMenu: $e\n');
}
```
