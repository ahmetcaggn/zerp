# openapi_sale.api.ProductPatchProductApi
...
------------- | ------------- | -------------
[**patchProduct**](ProductPatchProductApi.md#) | **PATCH** /sale/products/{id} | Update: Update an existing entity


# **patchProduct**
> ApiResponseProductDTO patchProduct(id, requestBody)
...
final api_instance = ProductPatchProductApi();
final id = 1; // String | Unique identifier of the entity to update
final requestBody = Map<String, Object>(); // Map<String, Object> | 

try {
    final result = api_instance.patchProduct(id, requestBody);
    print(result);
} catch (e) {
    print('Exception when calling ProductPatchProductApi->patchProduct: $e\n');
}
```
