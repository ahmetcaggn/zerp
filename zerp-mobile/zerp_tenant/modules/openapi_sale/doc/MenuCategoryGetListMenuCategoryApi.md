# openapi_sale.api.MenuCategoryGetListMenuCategoryApi
...
------------- | ------------- | -------------
[**getListMenuCategory**](MenuCategoryGetListMenuCategoryApi.md#) | **GET** /sale/menu-categories | GetList: Get paginated list of entities with filtering


# **getListMenuCategory**
> ApiResponseListMenuCategoryDTO getListMenuCategory(start, end, allParams, sort, order, embed)
...
final api_instance = MenuCategoryGetListMenuCategoryApi();
...
try {
    final result = api_instance.getListMenuCategory(start, end, allParams, sort, order, embed);
    print(result);
} catch (e) {
    print('Exception when calling MenuCategoryGetListMenuCategoryApi->getListMenuCategory: $e\n');
}
```
...
[**ApiResponseListMenuCategoryDTO**](ApiResponseListMenuCategoryDTO.md)
