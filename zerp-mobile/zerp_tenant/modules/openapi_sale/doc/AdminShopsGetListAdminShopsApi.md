# openapi_sale.api.AdminShopsGetListAdminShopsApi
...
------------- | ------------- | -------------
[**getListAdminShops**](AdminShopsGetListAdminShopsApi.md#) | **GET** /sale/admin/shops | GetList: Get paginated list of entities with filtering


# **getListAdminShops**
> ApiResponseListAdminShopResponseDTO getListAdminShops(start, end, allParams, sort, order, embed)
...
final api_instance = AdminShopsGetListAdminShopsApi();
...
try {
    final result = api_instance.getListAdminShops(start, end, allParams, sort, order, embed);
    print(result);
} catch (e) {
    print('Exception when calling AdminShopsGetListAdminShopsApi->getListAdminShops: $e\n');
}
```
