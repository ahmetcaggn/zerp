# openapi_sale.api.TableOrderGetManyTableOrderApi
...
------------- | ------------- | -------------
[**getManyTableOrder**](TableOrderGetManyTableOrderApi.md#) | **GET** /sale/table-orders/many | GetMany: Get multiple entities by IDs


# **getManyTableOrder**
> ApiResponseListTableOrderDTO getManyTableOrder(id)
...
final api_instance = TableOrderGetManyTableOrderApi();
final id = [[1, 5, 12]]; // List<String> | List of entity IDs to retrieve

try {
    final result = api_instance.getManyTableOrder(id);
    print(result);
} catch (e) {
    print('Exception when calling TableOrderGetManyTableOrderApi->getManyTableOrder: $e\n');
}
```
