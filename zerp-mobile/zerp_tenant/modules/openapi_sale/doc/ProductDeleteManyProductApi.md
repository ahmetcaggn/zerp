# openapi_sale.api.ProductDeleteManyProductApi
...
------------- | ------------- | -------------
[**deleteManyProduct**](ProductDeleteManyProductApi.md#) | **DELETE** /sale/products | DeleteMany: Delete multiple entities


# **deleteManyProduct**
> ApiResponseListUUID deleteManyProduct(id)
...
try {
    ...
    print('Exception when calling ProductDeleteManyProductApi->deleteManyProduct: $e\n');
}
```
