# openapi_sale.api.MenuItemPatchMenuItemApi
...
------------- | ------------- | -------------
[**patchMenuItem**](MenuItemPatchMenuItemApi.md#) | **PATCH** /sale/menu-items/{id} | Update: Update an existing entity


# **patchMenuItem**
> ApiResponseMenuItemDTO patchMenuItem(id, requestBody)
...
final api_instance = MenuItemPatchMenuItemApi();
final id = 1; // String | Unique identifier of the entity to update
final requestBody = Map<String, Object>(); // Map<String, Object> | 

try {
    final result = api_instance.patchMenuItem(id, requestBody);
    print(result);
} catch (e) {
    print('Exception when calling MenuItemPatchMenuItemApi->patchMenuItem: $e\n');
}
```
