...
part 'api_response_menu_item_dto.g.dart';
...
class ApiResponseMenuItemDTO extends Schema {
  ...
  factory ApiResponseMenuItemDTO.fromJson(Map<String, dynamic> json) => _$ApiResponseMenuItemDTOFromJson(json);

  Map<String, dynamic> toJson() => _$ApiResponseMenuItemDTOToJson(this);
  ...
  static List<ApiResponseMenuItemDTO> listFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = ApiResponseMenuItemDTO.fromJson(row as Map<String, dynamic>);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, ApiResponseMenuItemDTO> mapFromJson(dynamic json) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        final value = ApiResponseMenuItemDTO.fromJson(entry.value as Map<String, dynamic>);
        if (value != null) {
          map[entry.key] = value;
        }
      }
...
class ApiResponseMenuItemDTOFactory extends JsonSchemaFactory<ApiResponseMenuItemDTO> {
  ...
  @override
  ApiResponseMenuItemDTO fromJson(dynamic json) => ApiResponseMenuItemDTO.fromJson(json as Map<String, dynamic>);
}
