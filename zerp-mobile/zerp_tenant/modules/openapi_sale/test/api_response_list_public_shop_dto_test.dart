...
// tests for ApiResponseListPublicShopDTO
void main() {
  // final instance = ApiResponseListPublicShopDTO();

  group('test ApiResponseListPublicShopDTO', () {
    // bool success
    ...
    // List<PublicShopDTO> data (default value: const [])
