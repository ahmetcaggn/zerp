...
// tests for ApiResponseListShopTableDTO
void main() {
  // final instance = ApiResponseListShopTableDTO();

  group('test ApiResponseListShopTableDTO', () {
    // bool success
    ...
    // List<ShopTableDTO> data (default value: const [])
