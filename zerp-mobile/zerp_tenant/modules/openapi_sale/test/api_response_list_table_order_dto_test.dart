...
// tests for ApiResponseListTableOrderDTO
void main() {
  // final instance = ApiResponseListTableOrderDTO();

  group('test ApiResponseListTableOrderDTO', () {
    // bool success
    ...
    // List<TableOrderDTO> data (default value: const [])
