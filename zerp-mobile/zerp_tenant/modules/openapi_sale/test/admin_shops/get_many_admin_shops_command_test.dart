...
/// tests for AdminShopsGetManyAdminShopsApi
void main() {
  // final instance = AdminShopsGetManyAdminShopsApi();

  group('tests for AdminShopsGetManyAdminShopsApi', () {
    ...
    //
    //Future<ApiResponseListAdminShopResponseDTO> getManyAdminShops(List<String> id) async
    test('test getManyAdminShops', () async {
      // TODO
    });
