...
/// tests for AdminShopsGetListAdminShopsApi
void main() {
  // final instance = AdminShopsGetListAdminShopsApi();

  group('tests for AdminShopsGetListAdminShopsApi', () {
    ...
    //
    //Future<ApiResponseListAdminShopResponseDTO> getListAdminShops(int start, int end, Map<String, String> allParams, { String sort, String order, String embed }) async
    test('test getListAdminShops', () async {
      // TODO
    });
