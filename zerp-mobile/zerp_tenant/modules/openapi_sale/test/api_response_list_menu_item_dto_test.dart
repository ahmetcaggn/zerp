...
// tests for ApiResponseListMenuItemDTO
void main() {
  // final instance = ApiResponseListMenuItemDTO();

  group('test ApiResponseListMenuItemDTO', () {
    // bool success
    ...
    // List<MenuItemDTO> data (default value: const [])
