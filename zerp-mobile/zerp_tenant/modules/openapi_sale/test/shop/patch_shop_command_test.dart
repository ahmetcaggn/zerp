...
/// tests for ShopPatchShopApi
void main() {
  // final instance = ShopPatchShopApi();

  group('tests for ShopPatchShopApi', () {
    ...
    //
    //Future<ApiResponseShopDTO> patchShop(String id, Map<String, Object> requestBody) async
    test('test patchShop', () async {
      // TODO
    });
