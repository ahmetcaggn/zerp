...
/// tests for ShopPatchManyShopApi
void main() {
  // final instance = ShopPatchManyShopApi();

  group('tests for ShopPatchManyShopApi', () {
    ...
    //
    //Future<ApiResponseListUUID> patchManyShop(Map<String, Object> requestBody, { List<String> id }) async
    test('test patchManyShop', () async {
      // TODO
    });
