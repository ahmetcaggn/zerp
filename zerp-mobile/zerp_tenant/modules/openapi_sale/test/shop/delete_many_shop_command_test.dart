...
/// tests for ShopDeleteManyShopApi
void main() {
  // final instance = ShopDeleteManyShopApi();

  group('tests for ShopDeleteManyShopApi', () {
    ...
    //
    //Future<ApiResponseListUUID> deleteManyShop({ List<String> id }) async
    test('test deleteManyShop', () async {
      // TODO
    });
