...
/// tests for ShopGetManyShopApi
void main() {
  // final instance = ShopGetManyShopApi();

  group('tests for ShopGetManyShopApi', () {
    ...
    //
    //Future<ApiResponseListShopDTO> getManyShop(List<String> id) async
    test('test getManyShop', () async {
      // TODO
    });
