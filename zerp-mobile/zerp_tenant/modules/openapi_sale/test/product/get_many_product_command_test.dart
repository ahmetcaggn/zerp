...
/// tests for ProductGetManyProductApi
void main() {
  // final instance = ProductGetManyProductApi();

  group('tests for ProductGetManyProductApi', () {
    ...
    //
    //Future<ApiResponseListProductDTO> getManyProduct(List<String> id) async
    test('test getManyProduct', () async {
      // TODO
    });
