...
/// tests for ProductCreateProductApi
void main() {
  // final instance = ProductCreateProductApi();

  group('tests for ProductCreateProductApi', () {
    ...
    //
    //Future<ApiResponseProductDTO> createProduct(ProductCreateDTO productCreateDTO) async
