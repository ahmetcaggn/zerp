...
/// tests for ProductGetListProductApi
void main() {
  // final instance = ProductGetListProductApi();

  group('tests for ProductGetListProductApi', () {
    ...
    //
    //Future<ApiResponseListProductDTO> getListProduct(int start, int end, Map<String, String> allParams, { String sort, String order, String embed }) async
    test('test getListProduct', () async {
      // TODO
    });
