...
/// tests for ShopTableGetListShopTableApi
void main() {
  // final instance = ShopTableGetListShopTableApi();

  group('tests for ShopTableGetListShopTableApi', () {
    ...
    //
    //Future<ApiResponseListShopTableDTO> getListShopTable(int start, int end, Map<String, String> allParams, { String sort, String order, String embed }) async
    test('test getListShopTable', () async {
      // TODO
    });
