...
/// tests for ShopTableGetManyShopTableApi
void main() {
  // final instance = ShopTableGetManyShopTableApi();

  group('tests for ShopTableGetManyShopTableApi', () {
    ...
    //
    //Future<ApiResponseListShopTableDTO> getManyShopTable(List<String> id) async
    test('test getManyShopTable', () async {
      // TODO
    });
