...
/// tests for MenuCategoryGetListMenuCategoryApi
void main() {
  // final instance = MenuCategoryGetListMenuCategoryApi();

  group('tests for MenuCategoryGetListMenuCategoryApi', () {
    ...
    //
    //Future<ApiResponseListMenuCategoryDTO> getListMenuCategory(int start, int end, Map<String, String> allParams, { String sort, String order, String embed }) async
    test('test getListMenuCategory', () async {
      // TODO
    });
