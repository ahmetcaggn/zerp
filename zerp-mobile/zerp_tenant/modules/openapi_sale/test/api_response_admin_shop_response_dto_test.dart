...
// tests for ApiResponseAdminShopResponseDTO
void main() {
  // final instance = ApiResponseAdminShopResponseDTO();

  group('test ApiResponseAdminShopResponseDTO', () {
    // bool success
