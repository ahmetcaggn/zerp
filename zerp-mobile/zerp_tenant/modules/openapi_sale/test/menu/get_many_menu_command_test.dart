...
/// tests for MenuGetManyMenuApi
void main() {
  // final instance = MenuGetManyMenuApi();

  group('tests for MenuGetManyMenuApi', () {
    ...
    //
    //Future<ApiResponseListMenuDTO> getManyMenu(List<String> id) async
    test('test getManyMenu', () async {
      // TODO
    });
