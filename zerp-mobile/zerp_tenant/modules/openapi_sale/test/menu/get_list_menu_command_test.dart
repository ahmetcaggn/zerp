...
/// tests for MenuGetListMenuApi
void main() {
  // final instance = MenuGetListMenuApi();

  group('tests for MenuGetListMenuApi', () {
    ...
    //
    //Future<ApiResponseListMenuDTO> getListMenu(int start, int end, Map<String, String> allParams, { String sort, String order, String embed }) async
    test('test getListMenu', () async {
      // TODO
    });
