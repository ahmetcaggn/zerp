...
/// tests for MenuCreateMenuApi
void main() {
  // final instance = MenuCreateMenuApi();

  group('tests for MenuCreateMenuApi', () {
    ...
    //
    //Future<ApiResponseMenuDTO> createMenu(MenuCreateDTO menuCreateDTO) async
