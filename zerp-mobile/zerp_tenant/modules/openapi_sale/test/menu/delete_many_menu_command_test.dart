...
/// tests for MenuDeleteManyMenuApi
void main() {
  // final instance = MenuDeleteManyMenuApi();

  group('tests for MenuDeleteManyMenuApi', () {
    ...
    //
    //Future<ApiResponseListUUID> deleteManyMenu({ List<String> id }) async
    test('test deleteManyMenu', () async {
      // TODO
    });
