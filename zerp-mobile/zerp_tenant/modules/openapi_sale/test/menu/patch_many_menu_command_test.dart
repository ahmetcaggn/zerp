...
/// tests for MenuPatchManyMenuApi
void main() {
  // final instance = MenuPatchManyMenuApi();

  group('tests for MenuPatchManyMenuApi', () {
    ...
    //
    //Future<ApiResponseListUUID> patchManyMenu(Map<String, Object> requestBody, { List<String> id }) async
    test('test patchManyMenu', () async {
      // TODO
    });
