...
/// tests for MenuPatchMenuApi
void main() {
  // final instance = MenuPatchMenuApi();

  group('tests for MenuPatchMenuApi', () {
    ...
    //
    //Future<ApiResponseMenuDTO> patchMenu(String id, Map<String, Object> requestBody) async
