...
// tests for ApiResponseListProductDTO
void main() {
  // final instance = ApiResponseListProductDTO();

  group('test ApiResponseListProductDTO', () {
    // bool success
    ...
    // List<ProductDTO> data (default value: const [])
