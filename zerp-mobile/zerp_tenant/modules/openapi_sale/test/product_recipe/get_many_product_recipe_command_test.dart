...
/// tests for ProductRecipeGetManyProductRecipeApi
void main() {
  // final instance = ProductRecipeGetManyProductRecipeApi();

  group('tests for ProductRecipeGetManyProductRecipeApi', () {
    ...
    //
    //Future<ApiResponseListProductRecipeDTO> getManyProductRecipe(List<String> id) async
    test('test getManyProductRecipe', () async {
      // TODO
    });
