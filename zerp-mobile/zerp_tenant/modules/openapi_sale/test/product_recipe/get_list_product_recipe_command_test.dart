...
/// tests for ProductRecipeGetListProductRecipeApi
void main() {
  // final instance = ProductRecipeGetListProductRecipeApi();

  group('tests for ProductRecipeGetListProductRecipeApi', () {
    ...
    //
    //Future<ApiResponseListProductRecipeDTO> getListProductRecipe(int start, int end, Map<String, String> allParams, { String sort, String order, String embed }) async
    test('test getListProductRecipe', () async {
      // TODO
    });
