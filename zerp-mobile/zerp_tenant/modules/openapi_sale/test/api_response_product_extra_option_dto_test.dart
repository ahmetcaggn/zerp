...
// tests for ApiResponseProductExtraOptionDTO
void main() {
  // final instance = ApiResponseProductExtraOptionDTO();

  group('test ApiResponseProductExtraOptionDTO', () {
    // bool success
