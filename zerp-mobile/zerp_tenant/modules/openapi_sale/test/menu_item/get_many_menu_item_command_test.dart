...
/// tests for MenuItemGetManyMenuItemApi
void main() {
  // final instance = MenuItemGetManyMenuItemApi();

  group('tests for MenuItemGetManyMenuItemApi', () {
    ...
    //
    //Future<ApiResponseListMenuItemDTO> getManyMenuItem(List<String> id) async
    test('test getManyMenuItem', () async {
      // TODO
    });
