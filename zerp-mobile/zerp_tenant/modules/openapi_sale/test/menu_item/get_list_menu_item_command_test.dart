...
/// tests for MenuItemGetListMenuItemApi
void main() {
  // final instance = MenuItemGetListMenuItemApi();

  group('tests for MenuItemGetListMenuItemApi', () {
    ...
    //
    //Future<ApiResponseListMenuItemDTO> getListMenuItem(int start, int end, Map<String, String> allParams, { String sort, String order, String embed }) async
    test('test getListMenuItem', () async {
      // TODO
    });
