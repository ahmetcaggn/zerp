...
/// tests for TableOrderGetManyTableOrderApi
void main() {
  // final instance = TableOrderGetManyTableOrderApi();

  group('tests for TableOrderGetManyTableOrderApi', () {
    ...
    //
    //Future<ApiResponseListTableOrderDTO> getManyTableOrder(List<String> id) async
    test('test getManyTableOrder', () async {
      // TODO
    });
