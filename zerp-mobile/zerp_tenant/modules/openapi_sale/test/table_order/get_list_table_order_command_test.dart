...
/// tests for TableOrderGetListTableOrderApi
void main() {
  // final instance = TableOrderGetListTableOrderApi();

  group('tests for TableOrderGetListTableOrderApi', () {
    ...
    //
    //Future<ApiResponseListTableOrderDTO> getListTableOrder(int start, int end, Map<String, String> allParams, { String sort, String order, String embed }) async
    test('test getListTableOrder', () async {
      // TODO
    });
