...
/// tests for ProductExtraOptionGetListProductExtraOptionApi
void main() {
  // final instance = ProductExtraOptionGetListProductExtraOptionApi();

  group('tests for ProductExtraOptionGetListProductExtraOptionApi', () {
    ...
    //
    //Future<ApiResponseListProductExtraOptionDTO> getListProductExtraOption(int start, int end, Map<String, String> allParams, { String sort, String order, String embed }) async
    test('test getListProductExtraOption', () async {
      // TODO
    });
