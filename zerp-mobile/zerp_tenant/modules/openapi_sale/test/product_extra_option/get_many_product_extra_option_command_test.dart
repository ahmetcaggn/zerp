...
/// tests for ProductExtraOptionGetManyProductExtraOptionApi
void main() {
  // final instance = ProductExtraOptionGetManyProductExtraOptionApi();

  group('tests for ProductExtraOptionGetManyProductExtraOptionApi', () {
    ...
    //
    //Future<ApiResponseListProductExtraOptionDTO> getManyProductExtraOption(List<String> id) async
    test('test getManyProductExtraOption', () async {
      // TODO
    });
