# openapi_user.api.PermittablesGetListPermittablesApi
...
------------- | ------------- | -------------
[**getListPermittables**](PermittablesGetListPermittablesApi.md#) | **GET** /user/permittables | GetList: Get paginated list of entities with filtering


# **getListPermittables**
> ApiResponseListPermittableResponseDTO getListPermittables(start, end, allParams, sort, order, embed)
...
final api_instance = PermittablesGetListPermittablesApi();
...
try {
    final result = api_instance.getListPermittables(start, end, allParams, sort, order, embed);
    print(result);
} catch (e) {
    print('Exception when calling PermittablesGetListPermittablesApi->getListPermittables: $e\n');
}
```
...
[**ApiResponseListPermittableResponseDTO**](ApiResponseListPermittableResponseDTO.md)
