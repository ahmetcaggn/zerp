# openapi_user.api.UsersGetManyUsersApi
...
------------- | ------------- | -------------
[**getManyUsers**](UsersGetManyUsersApi.md#) | **GET** /user/many | GetMany: Get multiple entities by IDs


# **getManyUsers**
> ApiResponseListUserResponseDTO getManyUsers(id)
...
try {
    ...
    print('Exception when calling UsersGetManyUsersApi->getManyUsers: $e\n');
}
```
