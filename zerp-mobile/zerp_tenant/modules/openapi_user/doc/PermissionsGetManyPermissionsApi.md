# openapi_user.api.PermissionsGetManyPermissionsApi
...
------------- | ------------- | -------------
[**getManyPermissions**](PermissionsGetManyPermissionsApi.md#) | **GET** /user/permissions/many | GetMany: Get multiple entities by IDs


# **getManyPermissions**
> ApiResponseListPermissionResponse getManyPermissions(id)
...
final api_instance = PermissionsGetManyPermissionsApi();
final id = [[1,5,12]]; // List<int> | List of entity IDs to retrieve

try {
    final result = api_instance.getManyPermissions(id);
    print(result);
} catch (e) {
    print('Exception when calling PermissionsGetManyPermissionsApi->getManyPermissions: $e\n');
}
```
