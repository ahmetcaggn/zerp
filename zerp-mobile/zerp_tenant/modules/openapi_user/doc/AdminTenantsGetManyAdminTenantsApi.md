# openapi_user.api.AdminTenantsGetManyAdminTenantsApi
...
------------- | ------------- | -------------
[**getManyAdminTenants**](AdminTenantsGetManyAdminTenantsApi.md#) | **GET** /user/tenants/many | GetMany: Get multiple entities by IDs


# **getManyAdminTenants**
> ApiResponseListTenantResponseDTO getManyAdminTenants(id)
...
final api_instance = AdminTenantsGetManyAdminTenantsApi();
final id = [[1,5,12]]; // List<String> | List of entity IDs to retrieve

try {
    final result = api_instance.getManyAdminTenants(id);
    print(result);
} catch (e) {
    print('Exception when calling AdminTenantsGetManyAdminTenantsApi->getManyAdminTenants: $e\n');
}
```
