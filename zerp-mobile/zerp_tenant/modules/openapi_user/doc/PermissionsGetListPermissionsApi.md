# openapi_user.api.PermissionsGetListPermissionsApi
...
------------- | ------------- | -------------
[**getListPermissions**](PermissionsGetListPermissionsApi.md#) | **GET** /user/permissions | GetList: Get paginated list of entities with filtering


# **getListPermissions**
> ApiResponseListPermissionResponse getListPermissions(start, end, allParams, sort, order, embed)
...
final api_instance = PermissionsGetListPermissionsApi();
...
try {
    final result = api_instance.getListPermissions(start, end, allParams, sort, order, embed);
    print(result);
} catch (e) {
    print('Exception when calling PermissionsGetListPermissionsApi->getListPermissions: $e\n');
}
```
...
[**ApiResponseListPermissionResponse**](ApiResponseListPermissionResponse.md)
