# openapi_user.api.UsersGetListUsersApi
...
------------- | ------------- | -------------
[**getListUsers**](UsersGetListUsersApi.md#) | **GET** /user | GetList: Get paginated list of entities with filtering


# **getListUsers**
> ApiResponseListUserResponseDTO getListUsers(start, end, allParams, sort, order, embed)
...
final api_instance = UsersGetListUsersApi();
...
try {
    final result = api_instance.getListUsers(start, end, allParams, sort, order, embed);
    print(result);
} catch (e) {
    print('Exception when calling UsersGetListUsersApi->getListUsers: $e\n');
}
```
...
[**ApiResponseListUserResponseDTO**](ApiResponseListUserResponseDTO.md)
