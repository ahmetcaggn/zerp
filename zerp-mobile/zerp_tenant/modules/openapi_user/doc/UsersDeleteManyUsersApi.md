# openapi_user.api.UsersDeleteManyUsersApi
...
------------- | ------------- | -------------
[**deleteManyUsers**](UsersDeleteManyUsersApi.md#) | **DELETE** /user | DeleteMany: Delete multiple entities


# **deleteManyUsers**
> ApiResponseListUUID deleteManyUsers(id)
...
final api_instance = UsersDeleteManyUsersApi();
final id = [[1,2,3]]; // List<String> | List of entity IDs to delete

try {
    final result = api_instance.deleteManyUsers(id);
    print(result);
} catch (e) {
    print('Exception when calling UsersDeleteManyUsersApi->deleteManyUsers: $e\n');
}
```
