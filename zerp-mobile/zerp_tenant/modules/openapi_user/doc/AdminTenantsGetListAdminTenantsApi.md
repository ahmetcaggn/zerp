# openapi_user.api.AdminTenantsGetListAdminTenantsApi
...
------------- | ------------- | -------------
[**getListAdminTenants**](AdminTenantsGetListAdminTenantsApi.md#) | **GET** /user/tenants | GetList: Get paginated list of entities with filtering


# **getListAdminTenants**
> ApiResponseListTenantResponseDTO getListAdminTenants(start, end, allParams, sort, order, embed)
...
final api_instance = AdminTenantsGetListAdminTenantsApi();
...
try {
    final result = api_instance.getListAdminTenants(start, end, allParams, sort, order, embed);
    print(result);
} catch (e) {
    print('Exception when calling AdminTenantsGetListAdminTenantsApi->getListAdminTenants: $e\n');
}
```
...
[**ApiResponseListTenantResponseDTO**](ApiResponseListTenantResponseDTO.md)
