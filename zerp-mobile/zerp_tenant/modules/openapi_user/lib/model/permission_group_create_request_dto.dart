...
part 'permission_group_create_request_dto.g.dart';
...
class PermissionGroupCreateRequestDTO extends Schema {
  /// Returns a new [PermissionGroupCreateRequestDTO] instance.
  ...
  final PermissionGroupCreateRequestDTOScopeTypeEnum scopeType;

  @JsonKey(name: r'actions')
  final Set<PermissionGroupCreateRequestDTOActionsEnum> actions;

  /// The factory instance for creating [PermissionGroupCreateRequestDTO] from JSON.
  static const factory = PermissionGroupCreateRequestDTOFactory();

  factory PermissionGroupCreateRequestDTO.fromJson(Map<String, dynamic> json) => _$PermissionGroupCreateRequestDTOFromJson(json);

  Map<String, dynamic> toJson() => _$PermissionGroupCreateRequestDTOToJson(this);

  static List<PermissionGroupCreateRequestDTO> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <PermissionGroupCreateRequestDTO>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = PermissionGroupCreateRequestDTO.fromJson(row as Map<String, dynamic>);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, PermissionGroupCreateRequestDTO> mapFromJson(dynamic json) {
    final map = <String, PermissionGroupCreateRequestDTO>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = PermissionGroupCreateRequestDTO.fromJson(entry.value as Map<String, dynamic>);
        if (value != null) {
          map[entry.key] = value;
        }
      }
...
class PermissionGroupCreateRequestDTOFactory extends JsonSchemaFactory<PermissionGroupCreateRequestDTO> {
  const PermissionGroupCreateRequestDTOFactory();

  @override
  PermissionGroupCreateRequestDTO fromJson(dynamic json) => PermissionGroupCreateRequestDTO.fromJson(json as Map<String, dynamic>);
}



enum PermissionGroupCreateRequestDTOScopeTypeEnum {
@JsonValue('TENANT')
TENANT('TENANT'),
@JsonValue('SHOP')
SHOP('SHOP');

const PermissionGroupCreateRequestDTOScopeTypeEnum(this.value);
...
enum PermissionGroupCreateRequestDTOActionsEnum {
...
const PermissionGroupCreateRequestDTOActionsEnum(this.value);
