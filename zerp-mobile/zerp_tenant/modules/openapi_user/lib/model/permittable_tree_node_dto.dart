...
part 'permittable_tree_node_dto.g.dart';
...
class PermittableTreeNodeDTO extends Schema {
  /// Returns a new [PermittableTreeNodeDTO] instance.
  PermittableTreeNodeDTO({
    this.id,
    this.title,
    this.targetType,
    this.actions = const {},
  ...
  final PermittableTreeNodeDTOTargetTypeEnum? targetType;

  @JsonKey(name: r'actions')
  final Set<PermittableTreeNodeDTOActionsEnum> actions;

  @JsonKey(name: r'children')
  final List<PermittableTreeNodeDTO> children;

  /// The factory instance for creating [PermittableTreeNodeDTO] from JSON.
  static const factory = PermittableTreeNodeDTOFactory();

  factory PermittableTreeNodeDTO.fromJson(Map<String, dynamic> json) => _$PermittableTreeNodeDTOFromJson(json);

  Map<String, dynamic> toJson() => _$PermittableTreeNodeDTOToJson(this);

  static List<PermittableTreeNodeDTO> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <PermittableTreeNodeDTO>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = PermittableTreeNodeDTO.fromJson(row as Map<String, dynamic>);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, PermittableTreeNodeDTO> mapFromJson(dynamic json) {
    final map = <String, PermittableTreeNodeDTO>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = PermittableTreeNodeDTO.fromJson(entry.value as Map<String, dynamic>);
        if (value != null) {
          map[entry.key] = value;
        }
      }
...
class PermittableTreeNodeDTOFactory extends JsonSchemaFactory<PermittableTreeNodeDTO> {
  const PermittableTreeNodeDTOFactory();

  @override
  PermittableTreeNodeDTO fromJson(dynamic json) => PermittableTreeNodeDTO.fromJson(json as Map<String, dynamic>);
}



enum PermittableTreeNodeDTOTargetTypeEnum {
...
const PermittableTreeNodeDTOTargetTypeEnum(this.value);
...
enum PermittableTreeNodeDTOActionsEnum {
...
const PermittableTreeNodeDTOActionsEnum(this.value);
