...
part 'permission_group_patch_request_dto.g.dart';
...
class PermissionGroupPatchRequestDTO extends Schema {
  /// Returns a new [PermissionGroupPatchRequestDTO] instance.
  ...
  final PermissionGroupPatchRequestDTOScopeTypeEnum? scopeType;

  @JsonKey(name: r'actions')
  final Set<PermissionGroupPatchRequestDTOActionsEnum> actions;

  /// The factory instance for creating [PermissionGroupPatchRequestDTO] from JSON.
  static const factory = PermissionGroupPatchRequestDTOFactory();

  factory PermissionGroupPatchRequestDTO.fromJson(Map<String, dynamic> json) => _$PermissionGroupPatchRequestDTOFromJson(json);

  Map<String, dynamic> toJson() => _$PermissionGroupPatchRequestDTOToJson(this);

  static List<PermissionGroupPatchRequestDTO> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <PermissionGroupPatchRequestDTO>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = PermissionGroupPatchRequestDTO.fromJson(row as Map<String, dynamic>);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, PermissionGroupPatchRequestDTO> mapFromJson(dynamic json) {
    final map = <String, PermissionGroupPatchRequestDTO>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = PermissionGroupPatchRequestDTO.fromJson(entry.value as Map<String, dynamic>);
        if (value != null) {
          map[entry.key] = value;
        }
      }
...
class PermissionGroupPatchRequestDTOFactory extends JsonSchemaFactory<PermissionGroupPatchRequestDTO> {
  const PermissionGroupPatchRequestDTOFactory();

  @override
  PermissionGroupPatchRequestDTO fromJson(dynamic json) => PermissionGroupPatchRequestDTO.fromJson(json as Map<String, dynamic>);
}



enum PermissionGroupPatchRequestDTOScopeTypeEnum {
@JsonValue('TENANT')
TENANT('TENANT'),
@JsonValue('SHOP')
SHOP('SHOP');

const PermissionGroupPatchRequestDTOScopeTypeEnum(this.value);
...
enum PermissionGroupPatchRequestDTOActionsEnum {
...
const PermissionGroupPatchRequestDTOActionsEnum(this.value);
