...
part 'permission_group_update_request_dto.g.dart';
...
class PermissionGroupUpdateRequestDTO extends Schema {
  /// Returns a new [PermissionGroupUpdateRequestDTO] instance.
  ...
  final PermissionGroupUpdateRequestDTOScopeTypeEnum scopeType;

  @JsonKey(name: r'actions')
  final Set<PermissionGroupUpdateRequestDTOActionsEnum> actions;

  /// The factory instance for creating [PermissionGroupUpdateRequestDTO] from JSON.
  static const factory = PermissionGroupUpdateRequestDTOFactory();

  factory PermissionGroupUpdateRequestDTO.fromJson(Map<String, dynamic> json) => _$PermissionGroupUpdateRequestDTOFromJson(json);

  Map<String, dynamic> toJson() => _$PermissionGroupUpdateRequestDTOToJson(this);

  static List<PermissionGroupUpdateRequestDTO> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <PermissionGroupUpdateRequestDTO>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = PermissionGroupUpdateRequestDTO.fromJson(row as Map<String, dynamic>);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, PermissionGroupUpdateRequestDTO> mapFromJson(dynamic json) {
    final map = <String, PermissionGroupUpdateRequestDTO>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = PermissionGroupUpdateRequestDTO.fromJson(entry.value as Map<String, dynamic>);
        if (value != null) {
          map[entry.key] = value;
        }
      }
...
class PermissionGroupUpdateRequestDTOFactory extends JsonSchemaFactory<PermissionGroupUpdateRequestDTO> {
  const PermissionGroupUpdateRequestDTOFactory();

  @override
  PermissionGroupUpdateRequestDTO fromJson(dynamic json) => PermissionGroupUpdateRequestDTO.fromJson(json as Map<String, dynamic>);
}



enum PermissionGroupUpdateRequestDTOScopeTypeEnum {
@JsonValue('TENANT')
TENANT('TENANT'),
@JsonValue('SHOP')
SHOP('SHOP');

const PermissionGroupUpdateRequestDTOScopeTypeEnum(this.value);
...
enum PermissionGroupUpdateRequestDTOActionsEnum {
...
const PermissionGroupUpdateRequestDTOActionsEnum(this.value);
