...
part 'permission_create_request_dto.g.dart';
...
class PermissionCreateRequestDTO extends Schema {
  ...
  factory PermissionCreateRequestDTO.fromJson(Map<String, dynamic> json) => _$PermissionCreateRequestDTOFromJson(json);

  Map<String, dynamic> toJson() => _$PermissionCreateRequestDTOToJson(this);
  ...
  static List<PermissionCreateRequestDTO> listFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = PermissionCreateRequestDTO.fromJson(row as Map<String, dynamic>);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, PermissionCreateRequestDTO> mapFromJson(dynamic json) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        final value = PermissionCreateRequestDTO.fromJson(entry.value as Map<String, dynamic>);
        if (value != null) {
          map[entry.key] = value;
        }
      }
...
class PermissionCreateRequestDTOFactory extends JsonSchemaFactory<PermissionCreateRequestDTO> {
  ...
  @override
  PermissionCreateRequestDTO fromJson(dynamic json) => PermissionCreateRequestDTO.fromJson(json as Map<String, dynamic>);
}



enum PermissionCreateRequestDTOTargetTypeEnum {
...
const PermissionCreateRequestDTOTargetTypeEnum(this.value);
...
enum PermissionCreateRequestDTOActionEnum {
...
const PermissionCreateRequestDTOActionEnum(this.value);
