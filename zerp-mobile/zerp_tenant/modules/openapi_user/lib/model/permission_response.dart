  ...
  static List<PermissionResponse> listFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = PermissionResponse.fromJson(row as Map<String, dynamic>);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, PermissionResponse> mapFromJson(dynamic json) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        final value = PermissionResponse.fromJson(entry.value as Map<String, dynamic>);
        if (value != null) {
          map[entry.key] = value;
        }
      }
...
class PermissionResponseFactory extends JsonSchemaFactory<PermissionResponse> {
  ...
  @override
  PermissionResponse fromJson(dynamic json) => PermissionResponse.fromJson(json as Map<String, dynamic>);
}



enum PermissionResponseTargetTypeEnum {
...
const PermissionResponseTargetTypeEnum(this.value);
...
enum PermissionResponseActionEnum {
...
const PermissionResponseActionEnum(this.value);
