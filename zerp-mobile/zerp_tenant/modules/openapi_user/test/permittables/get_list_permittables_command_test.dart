...
/// tests for PermittablesGetListPermittablesApi
void main() {
  // final instance = PermittablesGetListPermittablesApi();

  group('tests for PermittablesGetListPermittablesApi', () {
    ...
    //
    //Future<ApiResponseListPermittableResponseDTO> getListPermittables(int start, int end, Map<String, String> allParams, { String sort, String order, String embed }) async
    test('test getListPermittables', () async {
      // TODO
    });
