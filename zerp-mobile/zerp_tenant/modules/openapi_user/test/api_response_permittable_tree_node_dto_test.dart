...
// tests for ApiResponsePermittableTreeNodeDTO
void main() {
  // final instance = ApiResponsePermittableTreeNodeDTO();

  group('test ApiResponsePermittableTreeNodeDTO', () {
    // bool success
