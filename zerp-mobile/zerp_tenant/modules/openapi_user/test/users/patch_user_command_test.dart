...
/// tests for UsersPatchUserApi
void main() {
  // final instance = UsersPatchUserApi();

  group('tests for UsersPatchUserApi', () {
    ...
    //
    //Future<ApiResponseUserResponseDTO> patchUser(String id, Map<String, Object> requestBody) async
