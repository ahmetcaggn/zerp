...
/// tests for UsersCreateUserApi
void main() {
  // final instance = UsersCreateUserApi();

  group('tests for UsersCreateUserApi', () {
    ...
    //
    //Future<ApiResponseUserResponseDTO> createUser(Object body) async
