...
/// tests for UsersGetManyUsersApi
void main() {
  // final instance = UsersGetManyUsersApi();

  group('tests for UsersGetManyUsersApi', () {
    ...
    //
    //Future<ApiResponseListUserResponseDTO> getManyUsers(List<String> id) async
    test('test getManyUsers', () async {
      // TODO
    });
