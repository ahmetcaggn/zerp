...
/// tests for UsersGetListUsersApi
void main() {
  // final instance = UsersGetListUsersApi();

  group('tests for UsersGetListUsersApi', () {
    ...
    //
    //Future<ApiResponseListUserResponseDTO> getListUsers(int start, int end, Map<String, String> allParams, { String sort, String order, String embed }) async
    test('test getListUsers', () async {
      // TODO
    });
