...
/// tests for PermissionsGetManyPermissionsApi
void main() {
  // final instance = PermissionsGetManyPermissionsApi();

  group('tests for PermissionsGetManyPermissionsApi', () {
    ...
    //
    //Future<ApiResponseListPermissionResponse> getManyPermissions(List<int> id) async
    test('test getManyPermissions', () async {
      // TODO
    });
