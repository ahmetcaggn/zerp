...
/// tests for PermissionsGetListPermissionsApi
void main() {
  // final instance = PermissionsGetListPermissionsApi();

  group('tests for PermissionsGetListPermissionsApi', () {
    ...
    //
    //Future<ApiResponseListPermissionResponse> getListPermissions(int start, int end, Map<String, String> allParams, { String sort, String order, String embed }) async
    test('test getListPermissions', () async {
      // TODO
    });
