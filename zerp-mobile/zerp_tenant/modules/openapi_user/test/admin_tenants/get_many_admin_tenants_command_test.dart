...
/// tests for AdminTenantsGetManyAdminTenantsApi
void main() {
  // final instance = AdminTenantsGetManyAdminTenantsApi();

  group('tests for AdminTenantsGetManyAdminTenantsApi', () {
    ...
    //
    //Future<ApiResponseListTenantResponseDTO> getManyAdminTenants(List<String> id) async
    test('test getManyAdminTenants', () async {
      // TODO
    });
