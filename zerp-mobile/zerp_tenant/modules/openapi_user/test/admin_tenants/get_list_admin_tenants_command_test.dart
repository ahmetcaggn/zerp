...
/// tests for AdminTenantsGetListAdminTenantsApi
void main() {
  // final instance = AdminTenantsGetListAdminTenantsApi();

  group('tests for AdminTenantsGetListAdminTenantsApi', () {
    ...
    //
    //Future<ApiResponseListTenantResponseDTO> getListAdminTenants(int start, int end, Map<String, String> allParams, { String sort, String order, String embed }) async
    test('test getListAdminTenants', () async {
      // TODO
    });
