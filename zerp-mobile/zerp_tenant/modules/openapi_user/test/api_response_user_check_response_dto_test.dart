...
// tests for ApiResponseUserCheckResponseDTO
void main() {
  // final instance = ApiResponseUserCheckResponseDTO();

  group('test ApiResponseUserCheckResponseDTO', () {
    // bool success
