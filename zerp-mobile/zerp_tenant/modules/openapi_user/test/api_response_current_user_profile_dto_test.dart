...
// tests for ApiResponseCurrentUserProfileDTO
void main() {
  // final instance = ApiResponseCurrentUserProfileDTO();

  group('test ApiResponseCurrentUserProfileDTO', () {
    // bool success
