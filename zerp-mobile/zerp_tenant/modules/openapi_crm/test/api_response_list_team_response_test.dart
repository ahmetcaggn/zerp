...
// tests for ApiResponseListTeamResponse
void main() {
  // final instance = ApiResponseListTeamResponse();

  group('test ApiResponseListTeamResponse', () {
    // bool success
    ...
    // List<TeamResponse> data (default value: const [])
