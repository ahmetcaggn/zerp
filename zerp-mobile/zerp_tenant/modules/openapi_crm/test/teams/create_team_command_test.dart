...
/// tests for TeamsCreateTeamApi
void main() {
  // final instance = TeamsCreateTeamApi();

  group('tests for TeamsCreateTeamApi', () {
    ...
    //
    //Future<ApiResponseTeamResponse> createTeam(CreateTeamRequest createTeamRequest) async
