...
/// tests for TeamsGetListTeamsApi
void main() {
  // final instance = TeamsGetListTeamsApi();

  group('tests for TeamsGetListTeamsApi', () {
    ...
    //
    //Future<ApiResponseListTeamResponse> getListTeams(int start, int end, Map<String, String> allParams, { String sort, String order, String embed }) async
    test('test getListTeams', () async {
      // TODO
    });
