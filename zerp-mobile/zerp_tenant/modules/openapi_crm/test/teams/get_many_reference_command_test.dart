...
/// tests for TeamsGetManyReferenceApi
void main() {
  // final instance = TeamsGetManyReferenceApi();

  group('tests for TeamsGetManyReferenceApi', () {
    ...
    //
    //Future<ApiResponseListTeamResponse> getManyReference(String target, String targetId, int start, int end, Map<String, String> allParams, { String sort, String order, String embed }) async
