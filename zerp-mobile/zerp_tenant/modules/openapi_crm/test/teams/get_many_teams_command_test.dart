...
/// tests for TeamsGetManyTeamsApi
void main() {
  // final instance = TeamsGetManyTeamsApi();

  group('tests for TeamsGetManyTeamsApi', () {
    ...
    //
    //Future<ApiResponseListTeamResponse> getManyTeams(List<String> id) async
    test('test getManyTeams', () async {
      // TODO
    });
