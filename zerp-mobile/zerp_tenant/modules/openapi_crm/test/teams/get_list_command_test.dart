...
/// tests for TeamsGetListApi
void main() {
  // final instance = TeamsGetListApi();

  group('tests for TeamsGetListApi', () {
    ...
    //
    //Future<ApiResponseListTeamResponse> getList(int start, int end, Map<String, String> allParams, { String sort, String order, String embed }) async
