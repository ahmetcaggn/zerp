...
/// tests for TeamsPatchTeamApi
void main() {
  // final instance = TeamsPatchTeamApi();

  group('tests for TeamsPatchTeamApi', () {
    ...
    //
    //Future<ApiResponseTeamResponse> patchTeam(String id, Map<String, Object> requestBody) async
