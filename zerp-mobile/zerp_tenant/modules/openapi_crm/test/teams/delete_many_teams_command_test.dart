...
/// tests for TeamsDeleteManyTeamsApi
void main() {
  // final instance = TeamsDeleteManyTeamsApi();

  group('tests for TeamsDeleteManyTeamsApi', () {
    ...
    //
    //Future<ApiResponseListUUID> deleteManyTeams({ List<String> id }) async
    test('test deleteManyTeams', () async {
      // TODO
    });
