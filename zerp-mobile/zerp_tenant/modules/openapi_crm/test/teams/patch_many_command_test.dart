...
/// tests for TeamsPatchManyApi
void main() {
  // final instance = TeamsPatchManyApi();

  group('tests for TeamsPatchManyApi', () {
    ...
    //
    //Future<ApiResponseListInteger> patchMany(Map<String, Object> requestBody, { List<int> id }) async
    test('test patchMany', () async {
      // TODO
    });
