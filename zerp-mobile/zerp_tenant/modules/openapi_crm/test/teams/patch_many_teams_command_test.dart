...
/// tests for TeamsPatchManyTeamsApi
void main() {
  // final instance = TeamsPatchManyTeamsApi();

  group('tests for TeamsPatchManyTeamsApi', () {
    ...
    //
    //Future<ApiResponseListUUID> patchManyTeams(Map<String, Object> requestBody, { List<String> id }) async
    test('test patchManyTeams', () async {
      // TODO
    });
