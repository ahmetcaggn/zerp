...
// tests for ApiResponseListTicketResponse
void main() {
  // final instance = ApiResponseListTicketResponse();

  group('test ApiResponseListTicketResponse', () {
    // bool success
    ...
    // List<TicketResponse> data (default value: const [])
