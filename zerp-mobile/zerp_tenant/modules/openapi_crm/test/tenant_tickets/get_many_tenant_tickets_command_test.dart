...
/// tests for TenantTicketsGetManyTenantTicketsApi
void main() {
  // final instance = TenantTicketsGetManyTenantTicketsApi();

  group('tests for TenantTicketsGetManyTenantTicketsApi', () {
    ...
    //
    //Future<ApiResponseListTicketResponse> getManyTenantTickets(List<String> id) async
    test('test getManyTenantTickets', () async {
      // TODO
    });
