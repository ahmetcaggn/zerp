...
/// tests for TenantTicketsGetListTenantTicketsApi
void main() {
  // final instance = TenantTicketsGetListTenantTicketsApi();

  group('tests for TenantTicketsGetListTenantTicketsApi', () {
    ...
    //
    //Future<ApiResponseListTicketResponse> getListTenantTickets(int start, int end, Map<String, String> allParams, { String sort, String order, String embed }) async
    test('test getListTenantTickets', () async {
      // TODO
    });
