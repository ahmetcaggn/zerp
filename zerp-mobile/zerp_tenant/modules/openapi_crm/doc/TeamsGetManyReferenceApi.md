# openapi_crm.api.TeamsGetManyReferenceApi
...
------------- | ------------- | -------------
[**getManyReference**](TeamsGetManyReferenceApi.md#) | **GET** /api/teams/of/{target}/{targetId} | GetManyReference: Get entities that reference another entity


# **getManyReference**
> ApiResponseListTeamResponse getManyReference(target, targetId, start, end, allParams, sort, order, embed)
...
final api_instance = TeamsGetManyReferenceApi();
...
try {
    final result = api_instance.getManyReference(target, targetId, start, end, allParams, sort, order, embed);
    print(result);
} catch (e) {
    print('Exception when calling TeamsGetManyReferenceApi->getManyReference: $e\n');
}
```
...
[**ApiResponseListTeamResponse**](ApiResponseListTeamResponse.md)
