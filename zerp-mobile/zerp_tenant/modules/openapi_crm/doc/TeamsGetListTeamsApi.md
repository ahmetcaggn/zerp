# openapi_crm.api.TeamsGetListTeamsApi
...
------------- | ------------- | -------------
[**getListTeams**](TeamsGetListTeamsApi.md#) | **GET** /crm/teams | GetList: Get paginated list of entities with filtering


# **getListTeams**
> ApiResponseListTeamResponse getListTeams(start, end, allParams, sort, order, embed)
...
final api_instance = TeamsGetListTeamsApi();
...
try {
    final result = api_instance.getListTeams(start, end, allParams, sort, order, embed);
    print(result);
} catch (e) {
    print('Exception when calling TeamsGetListTeamsApi->getListTeams: $e\n');
}
```
