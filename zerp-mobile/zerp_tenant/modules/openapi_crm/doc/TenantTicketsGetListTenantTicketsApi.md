# openapi_crm.api.TenantTicketsGetListTenantTicketsApi
...
------------- | ------------- | -------------
[**getListTenantTickets**](TenantTicketsGetListTenantTicketsApi.md#) | **GET** /crm/tickets | GetList: Get paginated list of entities with filtering


# **getListTenantTickets**
> ApiResponseListTicketResponse getListTenantTickets(start, end, allParams, sort, order, embed)
...
final api_instance = TenantTicketsGetListTenantTicketsApi();
...
try {
    final result = api_instance.getListTenantTickets(start, end, allParams, sort, order, embed);
    print(result);
} catch (e) {
    print('Exception when calling TenantTicketsGetListTenantTicketsApi->getListTenantTickets: $e\n');
}
```
