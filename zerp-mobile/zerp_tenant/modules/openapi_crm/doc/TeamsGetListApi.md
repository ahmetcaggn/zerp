# openapi_crm.api.TeamsGetListApi
...
------------- | ------------- | -------------
[**getList**](TeamsGetListApi.md#) | **GET** /api/teams | GetList: Get paginated list of entities with filtering


# **getList**
> ApiResponseListTeamResponse getList(start, end, allParams, sort, order, embed)
...
final api_instance = TeamsGetListApi();
...
try {
    ...
    print('Exception when calling TeamsGetListApi->getList: $e\n');
}
```
