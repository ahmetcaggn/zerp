# openapi_employee.api.EmployeesGetListApi
...
------------- | ------------- | -------------
[**getList**](EmployeesGetListApi.md#) | **GET** /employee | GetList: Get paginated list of entities with filtering


# **getList**
> ApiResponseListEmployeeListResponseDto getList(start, end, allParams, sort, order, embed)
...
final api_instance = EmployeesGetListApi();
...
try {
    ...
    print('Exception when calling EmployeesGetListApi->getList: $e\n');
}
```
