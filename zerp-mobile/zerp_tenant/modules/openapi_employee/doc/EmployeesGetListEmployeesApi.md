# openapi_employee.api.EmployeesGetListEmployeesApi
...
------------- | ------------- | -------------
[**getListEmployees**](EmployeesGetListEmployeesApi.md#) | **GET** /employee | GetList: Get paginated list of entities with filtering


# **getListEmployees**
> ApiResponseListEmployeeListResponseDto getListEmployees(start, end, allParams, sort, order, embed)
...
final api_instance = EmployeesGetListEmployeesApi();
...
try {
    final result = api_instance.getListEmployees(start, end, allParams, sort, order, embed);
    print(result);
} catch (e) {
    print('Exception when calling EmployeesGetListEmployeesApi->getListEmployees: $e\n');
}
```
