# openapi_employee.api.EmployeesPatchManyApi
...
------------- | ------------- | -------------
[**patchMany**](EmployeesPatchManyApi.md#) | **PATCH** /employee | UpdateMany: Update multiple entities


# **patchMany**
> ApiResponseListLong patchMany(requestBody, id)
...
final api_instance = EmployeesPatchManyApi();
...
try {
    ...
    print('Exception when calling EmployeesPatchManyApi->patchMany: $e\n');
}
```
