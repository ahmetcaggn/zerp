# openapi_employee.api.EmployeesPatchEmployeeApi
...
------------- | ------------- | -------------
[**patchEmployee**](EmployeesPatchEmployeeApi.md#) | **PATCH** /employee/{id} | Update: Update an existing entity


# **patchEmployee**
> ApiResponseEmployeeResponseDto patchEmployee(id, requestBody)
...
final api_instance = EmployeesPatchEmployeeApi();
final id = 1; // int | Unique identifier of the entity to update
final requestBody = Map<String, Object>(); // Map<String, Object> | 

try {
    final result = api_instance.patchEmployee(id, requestBody);
    print(result);
} catch (e) {
    print('Exception when calling EmployeesPatchEmployeeApi->patchEmployee: $e\n');
}
```
