# openapi_employee.api.EmployeesGetManyReferenceApi
...
------------- | ------------- | -------------
[**getManyReference**](EmployeesGetManyReferenceApi.md#) | **GET** /employee/of/{target}/{targetId} | GetManyReference: Get entities that reference another entity


# **getManyReference**
> ApiResponseListEmployeeListResponseDto getManyReference(target, targetId, start, end, allParams, sort, order, embed)
...
final api_instance = EmployeesGetManyReferenceApi();
...
try {
    ...
    print('Exception when calling EmployeesGetManyReferenceApi->getManyReference: $e\n');
}
```
