...
// tests for ApiResponseListEmployeeListResponseDto
void main() {
  // final instance = ApiResponseListEmployeeListResponseDto();

  group('test ApiResponseListEmployeeListResponseDto', () {
    // bool success
    ...
    // List<EmployeeListResponseDto> data (default value: const [])
