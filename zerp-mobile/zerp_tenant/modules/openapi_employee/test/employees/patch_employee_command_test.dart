...
/// tests for EmployeesPatchEmployeeApi
void main() {
  // final instance = EmployeesPatchEmployeeApi();

  group('tests for EmployeesPatchEmployeeApi', () {
    ...
    //
    //Future<ApiResponseEmployeeResponseDto> patchEmployee(int id, Map<String, Object> requestBody) async
    test('test patchEmployee', () async {
      // TODO
    });
