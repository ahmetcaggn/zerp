...
/// tests for EmployeesGetManyEmployeesApi
void main() {
  // final instance = EmployeesGetManyEmployeesApi();

  group('tests for EmployeesGetManyEmployeesApi', () {
    ...
    //
    //Future<ApiResponseListEmployeeResponseDto> getManyEmployees(List<String> id) async
    test('test getManyEmployees', () async {
      // TODO
    });
