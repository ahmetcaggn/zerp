...
/// tests for EmployeesUpdateEmployeeApi
void main() {
  // final instance = EmployeesUpdateEmployeeApi();

  group('tests for EmployeesUpdateEmployeeApi', () {
    ...
    //
    //Future<ApiResponseEmployeeResponseDto> updateEmployee(String id, UpdateEmployeeRequestDto updateEmployeeRequestDto) async
