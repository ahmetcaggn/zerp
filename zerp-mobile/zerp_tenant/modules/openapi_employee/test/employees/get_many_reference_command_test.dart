...
/// tests for EmployeesGetManyReferenceApi
void main() {
  // final instance = EmployeesGetManyReferenceApi();

  group('tests for EmployeesGetManyReferenceApi', () {
    ...
    //
    //Future<ApiResponseListEmployeeListResponseDto> getManyReference(String target, String targetId, int start, int end, Map<String, String> allParams, { String sort, String order, String embed }) async
    test('test getManyReference', () async {
      // TODO
    });
