...
// tests for AdminCreateEmployeeRequestDto
void main() {
  // final instance = AdminCreateEmployeeRequestDto();

  group('test AdminCreateEmployeeRequestDto', () {
    // String username
    ...
    // DateTime hireDate
    test('to test the property `hireDate`', () async {
      // TODO
    });
    ...
    // num salary
    test('to test the property `salary`', () async {
      // TODO
    });
    ...
    // List<EmployeeContactDto> contacts (default value: const [])
