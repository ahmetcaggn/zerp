# openapi_resource.api.StockResourceGetListStockResourceApi
...
------------- | ------------- | -------------
[**getListStockResource**](StockResourceGetListStockResourceApi.md#) | **GET** /resource/stock-resources | GetList: Get paginated list of entities with filtering


# **getListStockResource**
> ApiResponseListStockResourceDTO getListStockResource(start, end, allParams, sort, order, embed)
...
final api_instance = StockResourceGetListStockResourceApi();
...
try {
    final result = api_instance.getListStockResource(start, end, allParams, sort, order, embed);
    print(result);
} catch (e) {
    print('Exception when calling StockResourceGetListStockResourceApi->getListStockResource: $e\n');
}
```
