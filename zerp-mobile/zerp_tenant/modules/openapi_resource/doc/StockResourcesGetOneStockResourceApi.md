# openapi_resource.api.StockResourcesGetOneStockResourceApi
...
------------- | ------------- | -------------
[**getOneStockResource**](StockResourcesGetOneStockResourceApi.md#) | **GET** /{id} | GetOne: Get single entity by ID
...
final api_instance = StockResourcesGetOneStockResourceApi();
...
try {
    ...
    print('Exception when calling StockResourcesGetOneStockResourceApi->getOneStockResource: $e\n');
}
```
