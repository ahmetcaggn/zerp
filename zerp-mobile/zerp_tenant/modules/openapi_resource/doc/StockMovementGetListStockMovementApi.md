# openapi_resource.api.StockMovementGetListStockMovementApi
...
------------- | ------------- | -------------
[**getListStockMovement**](StockMovementGetListStockMovementApi.md#) | **GET** /resource/stock-movements | GetList: Get paginated list of entities with filtering


# **getListStockMovement**
> ApiResponseListStockMovementDTO getListStockMovement(start, end, allParams, sort, order, embed)
...
final api_instance = StockMovementGetListStockMovementApi();
...
try {
    final result = api_instance.getListStockMovement(start, end, allParams, sort, order, embed);
    print(result);
} catch (e) {
    print('Exception when calling StockMovementGetListStockMovementApi->getListStockMovement: $e\n');
}
```
