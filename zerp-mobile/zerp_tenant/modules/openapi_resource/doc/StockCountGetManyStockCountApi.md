# openapi_resource.api.StockCountGetManyStockCountApi
...
------------- | ------------- | -------------
[**getManyStockCount**](StockCountGetManyStockCountApi.md#) | **GET** /resource/stock-counts/many | GetMany: Get multiple entities by IDs


# **getManyStockCount**
> ApiResponseListStockCountDTO getManyStockCount(id)
...
final api_instance = StockCountGetManyStockCountApi();
final id = [[1, 5, 12]]; // List<String> | List of entity IDs to retrieve

try {
    final result = api_instance.getManyStockCount(id);
    print(result);
} catch (e) {
    print('Exception when calling StockCountGetManyStockCountApi->getManyStockCount: $e\n');
}
```
