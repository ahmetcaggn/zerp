# openapi_resource.api.StockCountGetListStockCountApi
...
------------- | ------------- | -------------
[**getListStockCount**](StockCountGetListStockCountApi.md#) | **GET** /resource/stock-counts | GetList: Get paginated list of entities with filtering


# **getListStockCount**
> ApiResponseListStockCountDTO getListStockCount(start, end, allParams, sort, order, embed)
...
final api_instance = StockCountGetListStockCountApi();
...
try {
    final result = api_instance.getListStockCount(start, end, allParams, sort, order, embed);
    print(result);
} catch (e) {
    print('Exception when calling StockCountGetListStockCountApi->getListStockCount: $e\n');
}
```
...
[**ApiResponseListStockCountDTO**](ApiResponseListStockCountDTO.md)
