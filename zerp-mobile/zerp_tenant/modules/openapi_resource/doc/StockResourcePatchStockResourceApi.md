# openapi_resource.api.StockResourcePatchStockResourceApi
...
------------- | ------------- | -------------
[**patchStockResource**](StockResourcePatchStockResourceApi.md#) | **PATCH** /resource/stock-resources/{id} | Update: Update an existing entity
...
final api_instance = StockResourcePatchStockResourceApi();
...
try {
    ...
    print('Exception when calling StockResourcePatchStockResourceApi->patchStockResource: $e\n');
}
```
