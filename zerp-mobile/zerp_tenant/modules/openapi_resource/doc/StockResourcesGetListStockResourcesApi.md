# openapi_resource.api.StockResourcesGetListStockResourcesApi
...
------------- | ------------- | -------------
[**getListStockResources**](StockResourcesGetListStockResourcesApi.md#) | **GET** / | GetList: Get paginated list of entities with filtering


# **getListStockResources**
> ApiResponseListStockResourceDTO getListStockResources(start, end, allParams, sort, order, embed)
...
final api_instance = StockResourcesGetListStockResourcesApi();
...
try {
    final result = api_instance.getListStockResources(start, end, allParams, sort, order, embed);
    print(result);
} catch (e) {
    print('Exception when calling StockResourcesGetListStockResourcesApi->getListStockResources: $e\n');
}
```
