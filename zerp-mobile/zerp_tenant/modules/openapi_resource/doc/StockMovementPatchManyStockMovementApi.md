# openapi_resource.api.StockMovementPatchManyStockMovementApi
...
------------- | ------------- | -------------
[**patchManyStockMovement**](StockMovementPatchManyStockMovementApi.md#) | **PATCH** /resource/stock-movements | UpdateMany: Update multiple entities


# **patchManyStockMovement**
> ApiResponseListUUID patchManyStockMovement(requestBody, id)
...
final api_instance = StockMovementPatchManyStockMovementApi();
final requestBody = Map<String, Object>(); // Map<String, Object> | 
final id = [[1, 2, 3]]; // List<String> | List of entity IDs to update

try {
    final result = api_instance.patchManyStockMovement(requestBody, id);
    print(result);
} catch (e) {
    print('Exception when calling StockMovementPatchManyStockMovementApi->patchManyStockMovement: $e\n');
}
```
