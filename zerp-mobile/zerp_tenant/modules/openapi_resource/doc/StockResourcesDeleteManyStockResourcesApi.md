# openapi_resource.api.StockResourcesDeleteManyStockResourcesApi
...
------------- | ------------- | -------------
[**deleteManyStockResources**](StockResourcesDeleteManyStockResourcesApi.md#) | **DELETE** / | DeleteMany: Delete multiple entities


# **deleteManyStockResources**
> ApiResponseListUUID deleteManyStockResources(id)
...
final api_instance = StockResourcesDeleteManyStockResourcesApi();
final id = [[1,2,3]]; // List<String> | List of entity IDs to delete

try {
    final result = api_instance.deleteManyStockResources(id);
    print(result);
} catch (e) {
    print('Exception when calling StockResourcesDeleteManyStockResourcesApi->deleteManyStockResources: $e\n');
}
```
