...
part 'api_response_list_stock_movement_dto.g.dart';
...
class ApiResponseListStockMovementDTO extends Schema {
  ...
  factory ApiResponseListStockMovementDTO.fromJson(Map<String, dynamic> json) => _$ApiResponseListStockMovementDTOFromJson(json);

  Map<String, dynamic> toJson() => _$ApiResponseListStockMovementDTOToJson(this);
  ...
  static List<ApiResponseListStockMovementDTO> listFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = ApiResponseListStockMovementDTO.fromJson(row as Map<String, dynamic>);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, ApiResponseListStockMovementDTO> mapFromJson(dynamic json) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        final value = ApiResponseListStockMovementDTO.fromJson(entry.value as Map<String, dynamic>);
        if (value != null) {
          map[entry.key] = value;
        }
      }
...
class ApiResponseListStockMovementDTOFactory extends JsonSchemaFactory<ApiResponseListStockMovementDTO> {
  ...
  @override
  ApiResponseListStockMovementDTO fromJson(dynamic json) => ApiResponseListStockMovementDTO.fromJson(json as Map<String, dynamic>);
}
