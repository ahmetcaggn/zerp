...
/// tests for StockResourcesGetListStockResourcesApi
void main() {
  // final instance = StockResourcesGetListStockResourcesApi();

  group('tests for StockResourcesGetListStockResourcesApi', () {
    ...
    //
    //Future<ApiResponseListStockResourceDTO> getListStockResources(int start, int end, Map<String, String> allParams, { String sort, String order, String embed }) async
    test('test getListStockResources', () async {
      // TODO
    });
