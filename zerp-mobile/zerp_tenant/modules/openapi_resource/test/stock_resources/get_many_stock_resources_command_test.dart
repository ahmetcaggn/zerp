...
/// tests for StockResourcesGetManyStockResourcesApi
void main() {
  // final instance = StockResourcesGetManyStockResourcesApi();

  group('tests for StockResourcesGetManyStockResourcesApi', () {
    ...
    //
    //Future<ApiResponseListStockResourceDTO> getManyStockResources(List<String> id) async
    test('test getManyStockResources', () async {
      // TODO
    });
