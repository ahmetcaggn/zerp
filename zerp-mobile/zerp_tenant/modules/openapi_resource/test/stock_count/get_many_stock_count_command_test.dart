...
/// tests for StockCountGetManyStockCountApi
void main() {
  // final instance = StockCountGetManyStockCountApi();

  group('tests for StockCountGetManyStockCountApi', () {
    ...
    //
    //Future<ApiResponseListStockCountDTO> getManyStockCount(List<String> id) async
    test('test getManyStockCount', () async {
      // TODO
    });
