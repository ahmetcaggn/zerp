...
/// tests for StockCountGetListStockCountApi
void main() {
  // final instance = StockCountGetListStockCountApi();

  group('tests for StockCountGetListStockCountApi', () {
    ...
    //
    //Future<ApiResponseListStockCountDTO> getListStockCount(int start, int end, Map<String, String> allParams, { String sort, String order, String embed }) async
    test('test getListStockCount', () async {
      // TODO
    });
