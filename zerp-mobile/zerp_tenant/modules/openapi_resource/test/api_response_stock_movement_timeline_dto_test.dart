...
// tests for ApiResponseStockMovementTimelineDTO
void main() {
  // final instance = ApiResponseStockMovementTimelineDTO();

  group('test ApiResponseStockMovementTimelineDTO', () {
    // bool success
