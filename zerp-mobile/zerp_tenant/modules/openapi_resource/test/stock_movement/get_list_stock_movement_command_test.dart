...
/// tests for StockMovementGetListStockMovementApi
void main() {
  // final instance = StockMovementGetListStockMovementApi();

  group('tests for StockMovementGetListStockMovementApi', () {
    ...
    //
    //Future<ApiResponseListStockMovementDTO> getListStockMovement(int start, int end, Map<String, String> allParams, { String sort, String order, String embed }) async
    test('test getListStockMovement', () async {
      // TODO
    });
