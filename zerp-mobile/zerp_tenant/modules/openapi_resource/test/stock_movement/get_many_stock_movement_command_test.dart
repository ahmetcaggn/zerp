...
/// tests for StockMovementGetManyStockMovementApi
void main() {
  // final instance = StockMovementGetManyStockMovementApi();

  group('tests for StockMovementGetManyStockMovementApi', () {
    ...
    //
    //Future<ApiResponseListStockMovementDTO> getManyStockMovement(List<String> id) async
    test('test getManyStockMovement', () async {
      // TODO
    });
