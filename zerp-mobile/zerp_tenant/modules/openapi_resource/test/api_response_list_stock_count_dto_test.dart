...
// tests for ApiResponseListStockCountDTO
void main() {
  // final instance = ApiResponseListStockCountDTO();

  group('test ApiResponseListStockCountDTO', () {
    // bool success
    ...
    // List<StockCountDTO> data (default value: const [])
