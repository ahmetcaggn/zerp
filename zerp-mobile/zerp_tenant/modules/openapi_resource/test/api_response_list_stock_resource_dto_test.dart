...
// tests for ApiResponseListStockResourceDTO
void main() {
  // final instance = ApiResponseListStockResourceDTO();

  group('test ApiResponseListStockResourceDTO', () {
    // bool success
    ...
    // List<StockResourceDTO> data (default value: const [])
