...
// tests for ApiResponseListStockOverviewDTO
void main() {
  // final instance = ApiResponseListStockOverviewDTO();

  group('test ApiResponseListStockOverviewDTO', () {
    // bool success
    ...
    // List<StockOverviewDTO> data (default value: const [])
