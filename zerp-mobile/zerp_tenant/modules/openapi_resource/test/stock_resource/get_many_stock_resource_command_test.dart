...
/// tests for StockResourceGetManyStockResourceApi
void main() {
  // final instance = StockResourceGetManyStockResourceApi();

  group('tests for StockResourceGetManyStockResourceApi', () {
    ...
    //
    //Future<ApiResponseListStockResourceDTO> getManyStockResource(List<String> id) async
    test('test getManyStockResource', () async {
      // TODO
    });
