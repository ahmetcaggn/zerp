...
/// tests for StockResourceGetListStockResourceApi
void main() {
  // final instance = StockResourceGetListStockResourceApi();

  group('tests for StockResourceGetListStockResourceApi', () {
    ...
    //
    //Future<ApiResponseListStockResourceDTO> getListStockResource(int start, int end, Map<String, String> allParams, { String sort, String order, String embed }) async
    test('test getListStockResource', () async {
      // TODO
    });
