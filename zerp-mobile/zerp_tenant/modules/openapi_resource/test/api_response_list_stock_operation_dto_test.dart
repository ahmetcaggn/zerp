...
// tests for ApiResponseListStockOperationDTO
void main() {
  // final instance = ApiResponseListStockOperationDTO();

  group('test ApiResponseListStockOperationDTO', () {
    // bool success
    ...
    // List<StockOperationDTO> data (default value: const [])
