...
// tests for ApiResponseListStockMovementDTO
void main() {
  // final instance = ApiResponseListStockMovementDTO();

  group('test ApiResponseListStockMovementDTO', () {
    // bool success
    ...
    // List<StockMovementDTO> data (default value: const [])
