...
import '../../storage/operator/auth_claims_operator.dart' as _i306;
import '../../storage/operator/auth_token_operator.dart' as _i743;
...
extension GetItInjectableX on _i174.GetIt {
  ...
  _i174.GetIt init({
    ...
    gh.factory<_i306.AuthClaimsOperator>(() => _i306.AuthClaimsOperator());
    gh.lazySingleton<_i337.FlutterAppAuth>(() => serviceModule.appAuth);
    gh.lazySingleton<_i558.FlutterSecureStorage>(
      () => serviceModule.secureStorage,
    );
    gh.factory<_i743.AuthTokenOperator>(
      () => _i743.AuthTokenOperator(gh<_i558.FlutterSecureStorage>()),
    );
    gh.factory<_i300.AuthService>(
      () => _i300.AuthService(
        gh<_i337.FlutterAppAuth>(),
        gh<_i743.AuthTokenOperator>(),
        gh<_i306.AuthClaimsOperator>(),
      ),
    );
